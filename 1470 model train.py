...
for env in range(1):
  ...
  for train_size in range(1):
    ...
    for iTimes in range(itera_max):   # 10 iterations
        ...
        model.save("SH Source Trained Model 1470")
...
for env in range(1):
  ...
  for train_size in range(1):
    ...
    for iTimes in range(itera_max):   # 10 iterations
        ...
        model.save("Lab Source Trained Model 1470")
...
for env in range(1):
  ...
  for train_size in range(1):
    ...
    for iTimes in range(itera_max):   # 10 iterations
        ...
        model.save("ML Source Trained Model 1470")
...
for env in range(1):
  ...
  for train_size in range(1):
    ...
    for iTimes in range(itera_max):   # 10 iterations
        ...
        model.save("NC Source Trained Model 1470")
